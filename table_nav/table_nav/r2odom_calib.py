...
rotation_speed = 0.2
occ_bins = [-1, 0, 100, 101] # -1 = unmapped, 0 = unoccupied, 100 = occupied, 101 = unknown
scanfile = 'lidar.txt'
mapfile = 'map.txt'
...
class TimmyTurner(Node):
    ...
    def odom_calib(self):
        self.get_logger().info('Odometry calibration initiated')
        self.angle = int(input('Enter angle to rotate: '))
        try:
            while rclpy.ok():
